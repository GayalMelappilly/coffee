...
const CoverImage = (props: Props) => {
    return (
        <div className='bg-white rounded-md p-10 h-72 flex items-end ml-5'>
            <a href="#_" className="relative inline-flex items-center justify-center p-4 mx-5 px-14 py-3 overflow-hidden font-medium transition duration-300 ease-out border-1 border-red-500 rounded-md shadow-[inset_0px_2px_10px_1px_rgba(0,_0,_0,_0.2)] group">
