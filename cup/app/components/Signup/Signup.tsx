...
const Signup:FC<Props> = ({username, setUsername, email, setEmail, password, setPassword, HandleSignUp}) => {
                ...
                <div className="max-w-sm w-full text-gray-600 space-y-8 mx-auto mt-10">
                    <div className="text-center">
                        <div className="mt-5 space-y-2">
                            ...
                            <p className="">Already have an account? <Link href="/sign-in" className="font-medium text-indigo-600 hover:text-indigo-500">Sign in</Link></p>
                        </div>
                    </div>
                    <form
