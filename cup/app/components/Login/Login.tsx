...
const Login: FC<Props> = ({ username, setUsername, password, setPassword, HandleLogin }) => {
    return (
        <>
            <div className='sm:hidden h-20 absolute w-screen'>
                <SmallBanner />
            </div>
            <main className="sm:w-1/2 w-full h-screen p-9 flex flex-col bg-zinc-100 justify-center mt-5">
